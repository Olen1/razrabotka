    ...
    async def create(
        ...
        for item_data in order_data.items:
            ...
            if product.stock_quantity < item_data.quantity:
                raise ValueError(
                    f"Not enough stock for product {item_data.product_id}. Required: {item_data.quantity}, Available: {product.stock_quantity}"
                )
        ...
        for item_data in order_data.items:
            ...
            success = await product_repository.decrease_stock(
            ...
            if not success:
                ...
                raise ValueError(
                    f"Stock reduction failed for product {item_data.product_id}"
                )
